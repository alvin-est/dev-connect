  ...
  return (
    <div className="flex min-h-screen bg-gray-50 font-body">
      ...
      <div className="flex flex-col justify-center items-center w-full md:w-1/2 bg-white shadow-md p-10">
        <h1 className="text-5xl font-bold text-primary mb-4">DevDeploy</h1>
        ...
        <div className="flex space-x-4 mt-4">
          <a href="#"
             className="px-6 py-3 text-white bg-primary font-semibold rounded-lg hover:bg-blue-700 transition duration-200">
            Sign Up
          </a>
          <a href="#"
             className="px-6 py-3 text-primary bg-secondary font-semibold rounded-lg hover:bg-orange-600 transition duration-200">
            Login
          </a>
        </div>
      </div>
